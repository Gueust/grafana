...
function (angular, _, queryDef) {
  ...
  module.directive('esMetricAgg', function() {
    return {
      templateUrl: 'app/plugins/datasource/es/partials/metric_agg.html',
      controller: 'EsMetricAggCtrl',
      restrict: 'E',
      scope: {
        target: "=",
        index: "=",
  ...
  module.controller('EsMetricAggCtrl', function($scope, uiSegmentSrv, $q, $rootScope) {
