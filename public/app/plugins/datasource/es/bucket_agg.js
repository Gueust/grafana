...
function (angular, _, queryDef) {
  ...
  module.directive('esBucketAgg', function() {
    return {
      templateUrl: 'app/plugins/datasource/es/partials/bucket_agg.html',
      controller: 'EsBucketAggCtrl',
      restrict: 'E',
      scope: {
        target: "=",
        index: "=",
  ...
  module.controller('EsBucketAggCtrl', function($scope, uiSegmentSrv, $q, $rootScope) {
    ...
    $rootScope.onAppEvent('es-query-updated', function() {
      $scope.validateModel();
